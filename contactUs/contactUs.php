    ...
    <div class="content">
      <div class="left-side">
        <div class="phone details">
          ...
          <div class="text-one">+923142205171</div>
          <div class="text-two">+923332440749</div>
        </div>
        <div class="email details">
          <i class="fas fa-envelope"></i>
          <div class="topic">Email</div>
          <div class="text-one">rjshiekh12@gmail.com</div>
          <div class="text-two">tubaali12@gmail.com</div>
        </div>
      </div>
