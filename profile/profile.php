            ...
            $userBlog .=
                "<div class='card px-0 py-0'>
                    <div class='image-data'>
                        ...
                        <img src='https://source.unsplash.com/featured/?food' alt='Food Image' style='width:100%; heigth:100%'></div>  
                ...
                <h1 class="create">Create Post</h2>
                    <form action="profile.php" method='POST'>
                        ...
                        <div class="txt_field">
                            ...
                            <span></span>
                            <label for="blogSubtitle">Ingridents</label>
                        </div>
                        ...
                        <a href="api.html" class="button">Ask Me!</a>
                    </form>
